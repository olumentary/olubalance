...
RSpec.feature "Accounts", type: :feature do
  ...
  scenario "user creates a new account and renames it" do
    ...
    click_link "Edit"
    fill_in "account_name", with: "Renamed Acct"
    click_button "Update"
    expect(page).to have_content "Renamed Acct"
  end

  # The card-footer "Deactivate" entry point was removed; a new entry point
  # for the deactivate flow will be added separately. Controller-level
  # coverage for the deactivate action lives in
